							...
							<div class="well">
								<div class="media headlines">
									<a class="pull-left" href="#"><img
										class="media-object img-rounded" src="/images/elyse.png"
										width="147" height="147"></a>
									<div class="media-body">
										<h4 class="media-heading">
											<strong>Bisi Oloye</strong>
										</h4>
										<h5 class="job">
										...
										<h5 class="job">
											<b>Experience Level:</b> Professional
										</h5>
										<h5 class="job">
											<b>Phone no:</b> 09088736102
										</h5>
										<h5 class="job">
											<b>Last Seen:</b> 36mins ago
										</h5>
										<h5 class="job">
											<b><a href="#">view full profile</a></b>
										</h5>
							...
							<form>
								...
								<div class="form-group">
									<label for="role">Role:</label> <select class="form-control"
										id="role">
										<option disabled="disabled" selected="selected" hidden>--choose
											role--</option>
								...
								<button id="create-user-btn" type="button"
