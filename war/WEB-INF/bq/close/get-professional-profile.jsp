	...
	<div class="container dashboard-body">
		...
		<div class="col-sm-7">
			<div class="row ">
				<div class="col-sm-12 card-panel no-padding-div">
					...
					<h4 style="margin-bottom: 4%; font-weight: bold;">Personal
						Information</h4>
					<div class="row">
						<div class="col-sm-3">
			...
			<div class="row">
				...
				<div class="col-sm-10 card-panel">
					<div class="col-sm-12 no-padding-div">
						<h4 style="margin-bottom: 4%; font-weight: bold;">
							Profile Summary</h4>
						...
						<div class="s-output">
							...
							<c:forEach var="item"
								...
								<div class="col-sm-12 module-div"
									...
									<h4 class="position" style="margin-top: 10px; color: #59983b">
							...
							<div class="s-output">
								...
								<c:forEach var="item"
									...
									<div class="col-sm-12 module-div"
										...
										<h4 class="instituition" style="margin-top: 10px; color: #59983b">
							...
							<div class="s-output">
								...
								<c:forEach var="item" items="${professionalProfileBean.awards}">
									<div class="col-sm-12 module-div"
										...
										<h4 class="name" style="margin-top: 10px; color: #59983b">
		...
		<div class="col-sm-5">
			...
			<div class="col-sm-12 card-panel no-padding-div">
				...
				<div class="col-sm-12">
					<label style="color: #59983b">Current State:</label> <span class="output"> <c:out
							value='${professionalProfileBean.currentState}' /></span>
				</div>

				<div class="col-sm-12">
					<label style="color: #59983b">Current Country:</label> <span class="output"> <c:out
							value='${professionalProfileBean.currentCountry}' />
					</span>
				</div>

				<div class="col-sm-12">
					<label style="color: #59983b">Nationality:</label> <span class="output"> <c:out
							value='${professionalProfileBean.nationality}' />
					</span>
				</div>

				<div class="col-sm-12">
					<label style="color: #59983b">State of Origin:</label> <span class="output"> <c:out
							value='${professionalProfileBean.stateOfOrigin}' />
					</span>
				</div>

				<div class="col-sm-12">
					<label style="color: #59983b">Gender:</label> <span class="output"> <c:out
							value='${professionalProfileBean.gender}' />
					</span>
				</div>

				<div class="col-sm-12">
					<label style="color: #59983b">Years of Experience:</label> <span class="output"> <c:out
							value='${professionalProfileBean.yearOfExperience}' />
					</span>
				</div>

				<div class="col-sm-12">
					<label style="color: #59983b">Career Level:</label> <span class="output"><c:out
