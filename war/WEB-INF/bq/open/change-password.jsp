			...
			<div class="login-div-1">
				...
				<div class="login-body">
					...
					<form id="change-password-form" method="post"
						action="<c:url value="/endpoint/bq/change-password" />">
						<div class="form-group">
							<p style="color: black">Your Password must contain at least a
								digit, an upper case and a lower case alphabet, and any special
